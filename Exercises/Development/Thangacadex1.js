...
(function() {
    ...
    var thangacadex1 = {	// Name of export object
	userInput: null,  // Boolean: Tells us if user ever did anything

	// Initialise the exercise
	initJSAV: function(arr_size) {
	    thangacadex1.userInput = false;
	    av = new JSAV("Thangacadex1", {animationMode: "none"});
	...
	thangacadex1.userInput = true;
    }
    // Export name used here
    window.thangacadex1 = window.thangacadex1 || thangacadex1;
}());
