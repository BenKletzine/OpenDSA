...
(function() {
    ...
    var kletzineArrayJSAV = {	// Name of export object
	userInput: null,  // Boolean: Tells us if user ever did anything

	// Initialise the exercise
	initJSAV: function(arr_size) {
	    kletzineArrayJSAV.userInput = false;
	    av = new JSAV("KletzineArrayJSAV", {animationMode: "none"});
	...
	kletzineArrayJSAV.userInput = true;
    }
    // Export name used here
    window.kletzineArrayJSAV = window.kletzineArrayJSAV || kletzineArrayJSAV;
}());
